...
let track_id = document.querySelector(".track-id");
...
function loadTrack(track_index) {
  ...
  var x=track_list[track_index].myradio;
  if (x){
    someplayer.className=x;
    
  }else{
    someplayer.className="";
  }
...
function synthe() {
$.ajax({url:"/songs/"+track_id.innerHTML+"/synthe"});
}
function idontlike() {
