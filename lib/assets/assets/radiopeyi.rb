...
@file1='./sample-data-radiopeyi.json'
...
def myfunc
  ...
  radio_json=JSON.load(URI.open("https://www.radiopeyi.com/flux/radiopeyicom/refresh.json"))
  p radio_json
  currentsong=radio_json["6"]["current_song"]
