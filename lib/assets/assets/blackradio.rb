...
def myfunc
  ...
  radio_json=JSON.load(URI.open("https://www.bblackradio.fm/flux/bblackradiofm/refresh.json"))
  #p radio_json
  currentsong=radio_json["35"]["current_song"]
