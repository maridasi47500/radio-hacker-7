...
@file1='./sample-data-nrjguyane.json'
...
def myfunc
  ...
  radio_json=JSON.load(URI.open("https://www.nrjguyane.fm/flux/nrjguyanefm/refresh.json"))
  p radio_json
  currentsong=radio_json["5"]["current_song"]
